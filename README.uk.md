...
- **Виводить** кожен статус зі змісту доказів, а не довіряє мітці рецензента: `нема доказу → locked`, тест-твердження оцінюються за власним результатом перевірки, а **суперечність між документами перекриває навіть вручну поставлений «verified»** — конфліктне демо дає **49/100 Blocked**, хоча кожен рядок позначено «verified» (див. [docs/scoring.md](docs/scoring.md)).
