...
*Українською · [English](project-faq.en.md)*

## Що таке UAV Readiness & Evidence Copilot?

UAV Readiness & Evidence Copilot — це безпечний інструмент для перевірки інженерної документації UAV та robotics. Він читає навчальні файли й генерує пакет перевірки з доказами: текстовий звіт, карту доказів, матрицю простежуваності (traceability — відстеження зв'язку твердження з доказом), цифрові відбитки файлів і демо-сторінку.
...
Поточний MVP (Minimum Viable Product — мінімально життєздатний продукт) читає тільки чотири навчальні вхідні файли:
