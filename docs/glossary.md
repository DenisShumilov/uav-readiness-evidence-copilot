...
*Українською · [English](glossary.en.md)*
...
- **BOM** — список деталей.
- **TDP** — Technical Data Package, технічний пакет даних: упорядкований набір технічних записів та індексів.
- **STANAG** — NATO Standardization Agreement, спільний стандарт НАТО.
